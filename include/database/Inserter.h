...
private:
     ...
     * @param work Trabalho
     */
    static void insertAttribute(uint relationID, uint attrIndex, const Attribute &attr, WorkPtr &work);
     ...
     * @param work Trabalho
     */
    static void insertInstance(uint relationID, uint instIndex, const Instance &inst, WorkPtr &work);
